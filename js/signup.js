angular.module('uiRoute')
  .controller('personsignupCtrl',  function ($scope,Myservice,Myservice1) {
 ...
 $scope.personSignUp=function(){
	 ...
	 $scope.detailsObj.userType='EXT';
						...
						var params = $scope.detailsObj;
							...
							Myservice1.uploadimage("http://62.12.118.38/Shamba/emp/register",formData).then(function(resp){
								if(resp.status=="success"){
									alert("success")
